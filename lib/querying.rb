...
def select_name_and_series_subgenres_of_authors
  "SELECT  Authors.name , series.title, Subgenres.name  From series  JOIN  Subgenres  ON series .id = series.subgenre_id  JOIN Authors ON Authors.id = series.author_id ;"
end
